# This is part of a codepipeline job that takes in the codepipeline job id and outputs a success or failure action
...
COMPONENT_BUCKET = << FILL THIS IN >>
COMPONENT_FILE = << FILL THIS IN >>
INFERENCE_COMPONENT_NAME = << FILL THIS IN >>
MODEL_COMPONENT_NAME = << FILL THIS IN >>
...
def lambda_handler(event, context):
    ...
    try:
        ...
        inf_comp['ComponentDependencies'][<< FILL THIS IN WITH YOUR MODEL STORE NAME>>]['VersionRequirement'] = str(
            "=" + model_component_version)
